        ...
        <div className="flex items-start space-x-2">
          ...
          <div>
            ...
            <p className="text-sm text-blue-600 mt-1">
              Email address cannot be changed for security reasons. If you need
  ...
  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-green-700 text-sm">
              You can now create listings and start earning money.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <Input
        ...
        onChange={(e) =>
          setHostInfo((prev) => ({ ...prev, businessName: e.target.value }))
        }
      ...
      <Input
        ...
        onChange={(e) =>
          setHostInfo((prev) => ({ ...prev, businessAddress: e.target.value }))
        }
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setHostInfo((prev) => ({ ...prev, description: e.target.value }))
          }
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start space-x-2">
          ...
          <div>
            ...
            <p className="text-sm text-blue-600 mt-1">
              Please ensure your phone number is updated in the Personal Info
              tab as it's required for host verification.
            </p>
          </div>
        </div>
      </div>
          ...
          {[
            {
              ...
              desc: "Get notified when someone books your items or your bookings change",
            },
            {
              key: "emailMessages",
              label: "Messages from hosts and renters",
              desc: "Receive emails when you get new messages",
            },
            {
              key: "emailPromotions",
              label: "Promotions and special offers",
              desc: "Hear about discounts, new features, and special events",
            },
          ].map((item) => (
          ...
          {[
            {
              ...
              desc: "Get SMS reminders about upcoming pickups and returns",
            },
            {
              key: "smsReminders",
              label: "Important reminders",
              desc: "Receive SMS for time-sensitive notifications",
            },
          ].map((item) => (
            <div key={item.key} className="flex items-start space-x-3">
              <input
        ...
        <div className="flex items-start space-x-2">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-600 mt-1">
              Notification preferences will be fully implemented in the next
              update. Your selections are saved locally for now.
            </p>
          </div>
        </div>
      </div>
...
const AlertMessage = ({ success, error }) => {
  ...
  return (
    <div
      className={`fixed top-4 right-4 max-w-md p-4 rounded-lg shadow-lg z-50 transition-all transform ${
        success
...
const Profile = () => {
  ...
  const tabs = [
    ...
    {
      id: "host",
      label: user?.isHost ? "Host Settings" : "Become a Host",
      icon: "🏠",
    },
