    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-xl lg:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto animate-slideInUp" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="max-w-3xl mx-auto animate-slideInUp" style={{ animationDelay: '0.4s' }}>
            <div className="relative group">
              <Search className={`absolute left-4 lg:left-6 top-1/2 transform -translate-y-1/2 h-5 w-5 lg:h-6 lg:w-6 transition-colors ${
                filters.search ? 'text-blue-500' : 'text-gray-500 group-hover:text-blue-500'
              }`} />
              <input
                type="text"
          ...
          <div className="mt-8 mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
            <div className="flex items-center justify-between">
              <div className="text-blue-800">
                <span className="font-semibold">{listings.length}</span> result{listings.length !== 1 ? 's' : ''} found
                {filters.search && (
                  <span className="ml-2">
