...
export const ListingsProvider = ({ children }) => {
  ...
  const addListingOptimistic = useCallback((newListing) => {
  ...
  const updateListingInCache = useCallback((listingId, updatedListing) => {
  ...
  const removeListingFromCache = useCallback((listingId) => {
