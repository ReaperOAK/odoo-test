...
import { listingsAPI, authAPI, ordersAPI, paymentsAPI, adminAPI } from '../lib/api';
...
function dataReducer(state, action) {
  switch (action.type) {
    ...
    case ActionTypes.SET_LISTINGS_SUCCESS:
      return { ...state, listings: action.payload, listingsLoading: false, listingsError: null };
    case ActionTypes.SET_LISTINGS_ERROR:
      return { ...state, listingsError: action.payload, listingsLoading: false };
    
    // Single listing
    case ActionTypes.SET_CURRENT_LISTING_LOADING:
      return { ...state, currentListingLoading: action.payload, currentListingError: null };
    case ActionTypes.SET_CURRENT_LISTING_SUCCESS:
      return { ...state, currentListing: action.payload, currentListingLoading: false, currentListingError: null };
    case ActionTypes.SET_CURRENT_LISTING_ERROR:
      return { ...state, currentListingError: action.payload, currentListingLoading: false };
    ...
    case ActionTypes.SET_ORDERS_SUCCESS:
      return { ...state, orders: action.payload, ordersLoading: false, ordersError: null };
    ...
    case ActionTypes.SET_ADMIN_STATS_SUCCESS:
      return { ...state, adminStats: action.payload, adminLoading: false, adminError: null };
    case ActionTypes.SET_ADMIN_USERS_SUCCESS:
      return { ...state, adminUsers: action.payload, adminLoading: false, adminError: null };
    case ActionTypes.SET_ADMIN_ORDERS_SUCCESS:
      return { ...state, adminOrders: action.payload, adminLoading: false, adminError: null };
    case ActionTypes.SET_ADMIN_REVENUE_SUCCESS:
      return { ...state, adminRevenue: action.payload, adminLoading: false, adminError: null };
    case ActionTypes.SET_ADMIN_ANALYTICS_SUCCESS:
      return { ...state, adminAnalytics: action.payload, adminLoading: false, adminError: null };
    case ActionTypes.SET_ADMIN_PAYOUTS_SUCCESS:
      return { ...state, adminPayouts: action.payload, adminLoading: false, adminError: null };
  ...
  const actions = useMemo(() => ({
    ...
    async fetchListings(filters = {}) {
      ...
      try {
        ...
        dispatch({ type: ActionTypes.SET_LISTINGS_SUCCESS, payload: listings });
        return listings;
      } catch (error) {
        dispatch({ type: ActionTypes.SET_LISTINGS_ERROR, payload: error.message });
        throw error;
      }
    },

    async fetchListing(id) {
      dispatch({ type: ActionTypes.SET_CURRENT_LISTING_LOADING, payload: true });
      try {
        const response = await listingsAPI.getById(id);
        const listing = response.data?.data || null;
        dispatch({ type: ActionTypes.SET_CURRENT_LISTING_SUCCESS, payload: listing });
        return listing;
      } catch (error) {
        dispatch({ type: ActionTypes.SET_CURRENT_LISTING_ERROR, payload: error.message });
        throw error;
      }
    },
    ...
    async fetchAdminStats() {
      ...
      try {
        ...
        dispatch({ type: ActionTypes.SET_ADMIN_STATS_SUCCESS, payload: stats });
        return stats;
      } catch (error) {
    ...
    async fetchAdminUsers() {
      ...
      try {
        ...
        dispatch({ type: ActionTypes.SET_ADMIN_USERS_SUCCESS, payload: users });
        return users;
      } catch (error) {
        dispatch({ type: ActionTypes.SET_ADMIN_ERROR, payload: error.message });
        throw error;
    ...
    async fetchAdminOrders() {
      ...
      try {
        ...
        const orders = response.data?.data || [];
        dispatch({ type: ActionTypes.SET_ADMIN_ORDERS_SUCCESS, payload: orders });
        return orders;
      } catch (error) {
        dispatch({ type: ActionTypes.SET_ADMIN_ERROR, payload: error.message });
        throw error;
    ...
    async fetchAdminRevenue() {
      ...
      try {
        ...
        dispatch({ type: ActionTypes.SET_ADMIN_REVENUE_SUCCESS, payload: revenue });
        return revenue;
      } catch (error) {
        dispatch({ type: ActionTypes.SET_ADMIN_ERROR, payload: error.message });
        throw error;
    ...
    async fetchAdminAnalytics() {
      ...
      try {
        ...
        dispatch({ type: ActionTypes.SET_ADMIN_ANALYTICS_SUCCESS, payload: analytics });
        return analytics;
      } catch (error) {
        dispatch({ type: ActionTypes.SET_ADMIN_ERROR, payload: error.message });
        throw error;
    ...
    async fetchAdminPayouts() {
      ...
      try {
        ...
        dispatch({ type: ActionTypes.SET_ADMIN_PAYOUTS_SUCCESS, payload: payouts });
        return payouts;
      } catch (error) {
        dispatch({ type: ActionTypes.SET_ADMIN_ERROR, payload: error.message });
        throw error;
